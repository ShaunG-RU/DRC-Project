    ...
    \begin{multicols*}{2}
        ...
        \section[Optimizing Compressor Performance]{Optimizing Compressor\\Performance}
            ...
            \subsection[Mixed Use of Peak Detection and RMS Level]{Mixed Use of Peak Detection\\and RMS Level} \label{sect:rms-peak-mix}
                ...
                Furthermore, by implementing a feature that automatically adjusts the mix between the peak and RMS level, governed by a PID controller that keeps the crest factor constant over a moving average signal, the compressor is able to automatically scale its attack and release values based on the input audio material.
