    ...
    \begin{multicols*}{2}
        ...
        \section{Compressor Topology} \label{sec:comp-tpgy}
            ...
            \subsection{Additional Topologies}
                In addition to feed-forward and feedback topologies, there are other methods in where a compressor can be implemented. Such topology often includes\dots
            ...
            \begin{figure*}[!t]
                ...
                \resizebox{\textwidth}{!}{%
                    \begin{tikzpicture}
                        ...
                        \node (input) at (0,0) {$x_{dB}(t)$};
                                                
                        % Blocks
                        \node[block, right = 0.5 of input] (abs) {Full Wave\\Rectifier};
                        \node[block, right = 0.5 of abs] (log) {Log.\\Amp};
