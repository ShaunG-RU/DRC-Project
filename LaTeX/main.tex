                ...
                \subsubsection{Layer Stackup}
                    ...
                    \begin{minipage}{\linewidth}
                        ...
                        \begin{tikzpicture}
                            ...
                            % S1
                            \fill[copper] (0,-0.4) rectangle ++(5,0.2);
                            
                            % V2
                            \fill[green!50] (0,-0.6) rectangle ++(5,0.2);

                            % S3
                            \fill[copper] (0,-0.8) rectangle ++(2,0.2);
                            \fill[green!50] (2,-0.8) rectangle ++(1,0.2);
                            \fill[copper] (3,-0.8) rectangle ++(2,0.2);

                            % V4
                            \fill[green!50] (0,-1.0) rectangle ++(5,0.2);
                            
                            % S5
                            \fill[copper] (0,-1.2) rectangle ++(2,0.2);
                            \fill[green!50] (2,-1.2) rectangle ++(1,0.2);
                            \fill[copper] (3,-1.2) rectangle ++(2,0.2);

                            % V6
                            \fill[green!50] (0,-1.4) rectangle ++(5,0.2);
                            
                            % S7
                            \fill[copper] (0,-1.6) rectangle ++(5,0.2);

                            % Labels
                            \node at (2.5,-0.3) {Sig. + PWR};
                            \node at (2.5,-0.7) {GND};
                            \node at (2.5,-1.1) {GND};
                            \node at (2.5,-1.5) {Sig. + PWR};
