        ...
        \section{Compressor Control Parameters}
            ...
            \begin{minipage}{\linewidth}
                ...
                \begin{tikzpicture}
                    ...
                    \draw [<->] (axis cs:-29,-5) -- (axis cs:-11,-5);
        
                    %\legend{No compression, 5:1 compression, hard knee, 5:1 compression, soft knee}
                                
                    % Knee Width
                    %\draw [<->] (axis cs:-25,2) -- (axis cs:-15,2);
                    
                    %\node at (axis cs:-30,-27) [anchor=east] {Make-up Gain};
                    %\node at (axis cs:-20,-46) [anchor=north] {Threshold};
                    %\node at (axis cs:-20,3) [anchor=south] {Knee Width};
                    
                    \end{axis}
                \end{tikzpicture}
                \captionof{figure}{Typical compression ratio characteristics.}
