        ...
        \section{Implementation of Discrete Circuit Compressor Components}
            ...
            \subsection{Gain Computer}
                ...
                \subsubsection{Precision Clipper}
                    \textcolor{blue}{Here we will discuss various implementation of analog clipping circuit, such as one shown in \ref{fig:neg-clipper}.}
                ...
                \subsubsection{Hyperbolic Tangent Function Cell}
                    In place of using log dividers and multipliers to achieve the quadratic knee compression characteristics described by equation \ref{eq:gain-comp}, a unique method of utilizing a hyperbolic tangent function can be implemented.\par
            ...
            \subsection{Voltage Controlled Amplifier}
                \textcolor{blue}{Here, I will discuss various implementations of gain control methods, such as variable-mu, optical, FET-based, diode-bridge, and VCA.}
