...
\begin{document}
    ...
    \fancyhead[RH]{\footnotesize{Technical Report | March 5, 2024}}
        ...
        \section{Discrete Circuit Implementation of Compressor Components}
            ...
            \subsection{Gain Computer}     
                ...
                \subsubsection{Analog Multiplier and Dividers} \label{sec:analog-mul-and-div}
                    ...
                    \noindent Furthermore, such set of operations using log and anti-log amplifiers could be implemented in the following manner.
