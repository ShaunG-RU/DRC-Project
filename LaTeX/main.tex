...
\begin{document}
    ...
    \begin{multicols*}{2}
        ...
        \section[Optimization of the Compressor Architecture]{Optimizing the Compressor\\ Architecture}
            ...
            \subsection{Detection Level Mixing}
            ...
            \subsection{Pre-Detection Filtering}
        ...
        \section{Implementation of Discrete Circuit Compressor Components}
            ...
            \subsection{Logarithmic Amplifiers}
                ...
                Conversely, the DC log amplifier incorporates either a diode or a diode-connected transistor within the feedback loop of an op-amp, limiting its frequency range to below 20 megahertz. This design is often utilized with sensors in control systems due to its frequency limitations.

                \subsubsection{Pseudo-Logarithmic Approximation}
                ...
                \subsubsection{Transimpedance Log Amplifier}
                    ...
                    \begin{minipage}{\linewidth}
                        ...
                        \begin{circuitikz} 
                            ...
                            \node[op amp, right = of input] (opamp) {};
                            \node[npn, above = of opamp, rotate = 90] (npn) {};
                            \node[sground, below = of npn.B] (gnd) {};
                    ...
                    \begin{equation}
                        V=\frac{kT}{q}ln(\frac{I_{in}}{I_{es}})
                    \end{equation}
            ...
            \subsection{Gain Computer}
                ...
                \subsubsection{Knee Level Management}
                    ...
                    \paragraph{Hyperbolic Tangent Function Cell}
                    ...
                    \paragraph{Precision Current Sink Source}
