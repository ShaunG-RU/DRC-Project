...
\graphicspath{{images/}}
\geometry{letterpaper, margin=1in, top=0.5in}
...
\begin{document}
    ...
    %{\bf Keyword:} Dynamic Range Compression, Analog Circuitry, Signal Processing, VCA, RMS/Peak Detection, PCB Design, Signal Integrity.\\

    %\smallskip
    %    \textbf{Keywords:} Dynamic Range Compression, Signal Processing, Discrete Circuit Design
    %\smallskip
    
    \begin{multicols}{2}

        %\textcolor{blue}{NOTE: This paper is incomplete. For empty sections, I have included changes I intend to make in the future. (in blue)}
        ...
        \section{Compressor Topology}
            ...
            \subsection{Feedback}  
                ...
                \begin{minipage}{\linewidth}
                    ...
                    \captionof{figure}{Control Diagram of a Feedback DRC Topology}
                    \label{fig:feedback}
            ...
            \subsection{Feedforward}
                ...
                \begin{minipage}{\linewidth}
                    ...
                    \captionof{figure}{Control Diagram of a Feed-Forward DRC Topology}
            ...
            \subsection{Optimal Topology}
                ...
                % Control diagram of the compressor
                \begin{figure*}[!th]
        ...
        \section{Circuit Implementation}
            ...
            \subsection{Miscellaneous Circuitry}
                ...
                \subsubsection{Gain Reduction Meter}
